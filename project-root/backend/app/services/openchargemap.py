...
async def get_charging_stations_async_max_result_(latitude, longitude, max_result=3, distance=100):
    stations = await get_charging_stations_async_max_result(latitude, longitude, maxresults=max_result, distance=distance)
    if not stations:
        return []
